...
export function TestimonialsScroll() {
  return (
    <section className="border-t border-[rgba(255,255,255,0.04)] py-[120px] overflow-hidden">
      ...
      >
        <div className="flex gap-6 animate-scroll-testimonials hover:[animation-play-state:paused] w-max">
          {/* Render twice for seamless loop */}
          {[...testimonials, ...testimonials].map((t, i) => (
            <div
              key={`${t.author}-${i}`}
              className="min-w-[380px] max-w-[380px] p-8 bg-surface border border-[rgba(255,255,255,0.06)] rounded-2xl flex-shrink-0 transition-all duration-300 hover:border-[rgba(147,51,234,0.2)]"
            >
