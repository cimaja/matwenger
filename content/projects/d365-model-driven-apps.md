...
caseStudy:
  ...
  introduction: >-
    ...
    need has room to breathe.
  leadMedia:
    kind: video
    index: 1
    caption: >-
      Before and after · The existing experience, the evidence and each proposed
      fix
  links:
    - label: Explore the prototype
      href: 'https://cimaja.github.io/proto-D365/'
    ...
    items:
      ...
      - title: Build close to production
        body: >-
          ...
          supports customer validation and gives engineering patterns it can
